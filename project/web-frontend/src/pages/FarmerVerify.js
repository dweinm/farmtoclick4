    ...
    <div className="farmer-verify-page">
      ...
      <section className="page-header">
        <div className="container">
          <h1>{user?.is_farmer ? 'Business Verification' : 'Apply as Farmer'}</h1>
          <p>
            {user?.is_farmer
              ? 'Submit a photo of your DTI Business Permit. We verify the QR code against the official DTI BNRS system.'
              : 'Submit your farm details and a photo of your DTI permit. We scan the QR code to verify your business registration.'}
          </p>
        </div>
      </section>
